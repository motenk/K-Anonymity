...
public class BasicMondrianKFirst{
	...
	//Written by:	Chris
	public BasicMondrianKFirst(ArrayList<Tuple> input, int k, ArrayList<TaxonomyTree> attributeTrees){
		data = input;
		this.k = k;
	...
	public BasicMondrianKFirst(ArrayList<Tuple> input, int k, ArrayList<TaxonomyTree> attributeTrees, int qid){
		data = input;
		this.k = k;
